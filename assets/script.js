...
var API_key = "206a80bb0bb9cb045e882f29faa1d613";
var getCoords = function (cityName) {
  ...
  fetch(lonlatAPI).then(function (response) {
    if (response.ok) {
        ...
        fetch(fiveDayAPI).then(function (response) {
          if (response.ok) {
            response.json().then(function (data) {
              ...
              var curHumidity = document.querySelector(
              ...
              var d1IconGet =
                "http://openweathermap.org/img/wn/" + d1wIcon + "@2x.png";
              ...
              var d2IconGet =
                "http://openweathermap.org/img/wn/" + d2wIcon + "@2x.png";
              ...
              var d3wIconGet =
                "http://openweathermap.org/img/wn/" + d3wIcon + "@2x.png";
              ...
              var d4wIconGet =
                "http://openweathermap.org/img/wn/" + d4wIcon + "@2x.png";
              ...
              var d5wiconGet =
                "http://openweathermap.org/img/wn/" + d5wIcon + "@2x.png";
